...
export default async function WishlistPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {items.length === 0 ? (
        <div className="text-center py-16 bg-[var(--bg-card)] border border-[var(--border)] rounded-3xl space-y-4">
          ...
          <div>
            <h3 className="font-bold text-[var(--text-primary)]">Your wishlist is empty</h3>
          ...
          {items.map((item) => (
            ...
            >
              <div>
                ...
                <h3 className="font-bold text-[var(--text-primary)] text-sm line-clamp-2 mb-4">
                  {item.title}
                </h3>
              </div>
              ...
              <div className="flex gap-2 pt-2 border-t border-slate-100 dark:border-slate-900 mt-2">
                ...
                >
                  <button
                    type="submit"
                    className="p-2 border border-slate-250 dark:border-[var(--border)] hover:bg-red-50 dark:hover:bg-red-950/20 text-red-500 rounded-xl transition-colors"
