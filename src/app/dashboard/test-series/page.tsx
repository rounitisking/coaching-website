  ...
  return (
    <div className="space-y-6 text-left">
      <div>
        ...
        <p className="text-[var(--text-muted)] mt-1">Practice with mock tests and view complete solutions.</p>
      </div>
      ...
      {purchases.length === 0 ? (
        <div className="p-12 rounded-3xl bg-[var(--bg-card)] border border-[var(--border)] text-center max-w-xl mx-auto mt-8">
          ...
          <h2 className="text-lg font-bold text-[var(--text-primary)]">No test series purchased</h2>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {purchases.map((pur) => {
            ...
            return (
              <div
                key={pur.id}
                className="card flex flex-col bg-[var(--bg-card)] overflow-hidden"
              >
                ...
                <div className="p-5 flex flex-col flex-grow">
                  ...
                  <div className="pt-4 border-t border-[var(--border)] mt-auto flex items-center justify-between text-xs text-[var(--text-muted)]">
