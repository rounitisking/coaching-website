    ...
    <div className="space-y-4">
      ...
      {notifications.length === 0 ? (
        <div className="p-12 rounded-3xl bg-[var(--bg-card)] border border-[var(--border)] text-center max-w-xl mx-auto mt-8">
          ...
          <h2 className="text-lg font-bold text-[var(--text-primary)]">All caught up!</h2>
            ...
            >
              <div
                className={`w-8 h-8 rounded-full flex items-center justify-center shrink-0 ${
                  n.isRead
                    ? "bg-[var(--bg-secondary)] text-slate-500 dark:bg-[var(--bg-secondary)]"
                ...
                <div className="flex items-center justify-between gap-2">
                  <h3
                    className={`text-sm font-bold truncate ${
                      n.isRead ? "text-[var(--text-primary)]" : "text-blue-950 dark:text-blue-200"
                    }`}
                  >
                    {n.title}
                  </h3>
              ...
              <div className="flex items-center gap-1.5 shrink-0 self-center">
                {!n.isRead && (
                  <button
                    ...
                    className="p-1.5 border border-[var(--border)] hover:bg-[var(--bg-secondary)] dark:hover:bg-[var(--bg-secondary)] rounded-lg text-slate-500 transition-colors"
                    title="Mark as read"
                  >
                    <Check size={14} />
                  </button>
                ...
                <button
                  ...
                  className="p-1.5 border border-[var(--border)] hover:bg-red-50 dark:hover:bg-red-950/20 rounded-lg text-red-500 transition-colors"
